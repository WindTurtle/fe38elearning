      ...
      <div className="comments__container">
        ...
        <div className="comments__carousel">
          <OwlCarousel
            ...
            margin={10}
            nav
            className="myCommentsCarousel owl-theme"
          >
            <div className="item">
              ...
              <div className="item__comment">
                APLearning is a life saver. I don't have the time or money for a
            ...
            <div className="item">
              ...
              <div className="item__comment">
                The best part about APLearning is the selection. You can find a
            ...
            <div className="item">
              ...
              <div className="item__comment">
                My children and I LOVE APLearning! The courses are fantastic and
                the instructors are so fun and knowledgeable. I only wish we
                found it sooner.
              </div>
            </div>
          </OwlCarousel>
